...
public class DietsCreator {
    ...
    public Diet createMeatEaterDiet() {
        ...
        float beefInDiet = userDietBeef*1/4;
        ...
        float chickenInDiet = tempChicken*3/4;
    ...
    public Diet createLowMeatDiet() {
        ...
        float tempChicken = tempPork - porkInDiet + userDietChicken;
        float chickenInDiet = tempChicken*1/2;
        ...
        float tempFish = proportionLeavingChicken*1/4 + userDietFish;
        float fishInDiet = tempFish*3/4;
        ...
        float tempEggs = proportionLeavingChicken - proportionLeavingChicken*1/4 + userDietEggs;
        float eggsInDiet = tempEggs*3/4;
        ...
        * Add remaining 50% of leftovers (2) and (3) with user vegetable proportions summing
        ...
        float beansInDiet = (proportionLeavingEggs + proportionLeavingFish)*1/2 + userDietBeans;
        float vegetablesInDiet = proportionLeavingEggs + proportionLeavingFish
                - (proportionLeavingEggs + proportionLeavingFish)*1/2 + userDietVegetables;
    ...
    public Diet createOnlyFishDiet() {
        ...
        float fishShare = proportionToSplit*2/5;
        ...
        float eggsShare = proportionToSplit*5/12;
    ...
    public Diet createVeganDiet() {
        ...
        float beansShare = proportionToSplit*4/5;
